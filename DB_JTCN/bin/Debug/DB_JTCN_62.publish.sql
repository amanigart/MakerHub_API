...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_ceinture_discipline]...';


GO
ALTER TABLE [dbo].[Ceinture]
    ADD CONSTRAINT [FK_ceinture_discipline] FOREIGN KEY ([idDiscipline]) REFERENCES [dbo].[Discipline] ([idDiscipline]);
