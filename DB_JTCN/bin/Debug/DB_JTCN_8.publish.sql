...
CREATE TABLE [dbo].[Salt] (
    [id_salt]        INT           IDENTITY (1, 1) NOT NULL,
    [id_utilisateur] INT           NOT NULL,
    [salt]           VARCHAR (100) NOT NULL,
    PRIMARY KEY CLUSTERED ([id_salt] ASC)
);
...
BEGIN
	...
	OUTPUT inserted.id_utilisateur INTO @tempId -- INTO @tempIdTable(id)
	VALUES (@login, @passwdHash)

	INSERT INTO Salt (id_utilisateur, salt)
	VALUES (@tempId, @salt) -- ((SELECT id FROM @tempIdTable), @salt)
END
GO
