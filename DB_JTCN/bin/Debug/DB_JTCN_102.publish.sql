...
AS
BEGIN
	INSERT INTO Membre (dateInscription, sexe, dateNaissance, groupeSanguin, autoriseImage, basePresencesRequises, basePresencesTotal, idPersonne)
	OUTPUT inserted.idMembre
	VALUES (@dateInscription, @sexe, @dateNaiss, @groupeSanguin, @autoriseImage, @presences, @presencesTotal, @idPersonne)
END
GO
...
EXEC RegisterMembre NULL, '2014-09-5', 'homme', '1985-04-23', NULL, 1, 21, 157, 9;
EXEC RegisterAppUtilisateur 'membre', 'membre', 2; 
...
EXEC RegisterMembre NULL, '2012-09-6', 'homme', '1985-04-23', NULL, 1, 23, 157, 10;
EXEC RegisterAppUtilisateur 'membre', 'membre', 2; 
